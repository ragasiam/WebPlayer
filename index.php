...
<html>
    ...
    <body>
        <div id='body-fx-wrapper'>
            ...
            <script>var radioName = "Ragasiam Radio";</script>
            <script>var host = "http://109.74.196.48:8251/stream";</script>
            ...
            <div id='foreground' onclick="GetInfo()">
                <audio crossorigin='' id='Stream' autoplay="" controls="">
                    <source src="http://109.74.196.48:8251/stream" type="audio/mp3">
                </audio>
                ...
                <div id='settings'>
                    <div id='settings-fx-wrapper'>
                        ...
                        <div id='settings-wrapper'>
                            <table><tr><td>Source:</td><td><input value='http://109.74.196.48:8251/stream' id='srInput'/><div onclick='NewSource()' class='btn'>Save</div></td></tr>
